...
import { ExternalLink, BookOpen, Award, ShieldCheck } from "lucide-react";
  ...
  return (
    <section className={styles.container} id="about-section">
      <div className={styles.inner}>
        ...
        {/* Section 1: Side-by-Side (Hero / Main Campus Image) */}
        <div className={styles.splitRow}>
          <div className={styles.textContent}>
            ...
            <p className={styles.paragraph}>
              ...
              at Barshi, Dist. Solapur. MIT Group's legacy in the field of revolutionary education
              inspired us to venture into the unique field of rail and transportation. MITCORER
              aspires to cultivate and train the students who will help/provide solutions to the
              greatest technological and social challenges of the 21st century.
            </p>
            <a
              href="https://www.mitcorer.edu.in"
              target="_blank"
